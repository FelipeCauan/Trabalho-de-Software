...
public class Produtos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        produtos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Valor", "Categoria", "Quantidade"
            }
        ) {
    ...
    private void Listar(){
        ...
        try{
            List<Produto> lista = pdao.read();
            for(Produto produto : lista){
                dtm.addRow(new Object[]{produto.getCod(),produto.getNome(),produto.getValor(),
                    produto.getCategoria(),produto.getQuantidade()
                });
            }
